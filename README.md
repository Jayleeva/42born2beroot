...
``fram=$(free -m | awk '$1 == "Mem:" \{print $2\}')\`` : va chercher dans les informations sur la mémoire, si la colonne 1 s'appelle "Mem:", imprime le contenu de la colonne 2, soit l'espace ram encore libre.
